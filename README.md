...
## Dependencies
* [git-lfs](https://git-lfs.github.com/), which is needed to get the [model file](./models/vggface16_pytorch_weights.pt). Alternatively, it can also be downloaded manually.
